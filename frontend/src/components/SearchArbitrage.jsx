...
const SearchArbitrage = () => {
  ...
  return (
    <div className="w-full mt-[10%] xl:mt-[5%]">
      <div className=" w-full flex flex-col md:px-20 xl:flex-row px-2 lg:px-10 py-5 gap-10 md:py-10 justify-center relative bg-[url('/src/assets/BGELEMENTS.png')] bg-cover bg-center">
        <svg
          width="300"
          height="300"
          viewBox="0 0 544 551"
      ...
      <div className="bg-[url('/src/assets/space.png')] bg-[#232233] bg-cover md:py-20 py-10">
        <div className="flex xl:flex-row flex-col justify-center items-center md:p-20 p-10">
          <div
            onMouseEnter={() => handleCardClick("card1")}
            className={`relative xl:h-[25rem] w-[25rem] rounded-3xl overflow-hidden xl:min-w-[25rem] cursor-pointer bg-[url('/src/assets/Group40.png')] bg-cover p-8 m-4 flex items-center justify-center gap-10 text-center text-white font-poppins transition-transform duration-500  ${
          ...
          <div
            ...
            className={`relative xl:h-[25rem] w-[25rem] rounded-3xl overflow-hidden xl:min-w-[25rem] cursor-pointer bg-[url('/src/assets/Group38.png')] bg-cover p-8 m-4 flex items-center justify-center gap-10 text-center text-white font-poppins transition-transform duration-500  ${
          ...
          <div
            ...
            className={`relative xl:h-[25rem] w-[25rem] rounded-3xl overflow-hidden xl:min-w-[25rem] cursor-pointer bg-[url('/src/assets/Group39.png')] bg-cover p-8 m-4 flex items-center justify-center gap-10 text-center text-white font-poppins transition-transform duration-500  ${
