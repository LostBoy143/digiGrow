    ...
    return (
        <div className="bg-[url('/assets/traffic-bg.png')] bg-auto bg-center bg-cover bg-no-repeat">
            <div className="flex flex-col items-center relative">
                <div className="font-poppins text-[64px] font-bold py-[28px]">Top Traffic Sources</div>

                <div className="flex flex-row flex-wrap gap-x-[44px] gap-y-[64px] justify-center pb-[58px] z-2">
                    <img className="h-[180px]" src="/assets/Media Buying Card (1).png" alt="" />
                    <img className="h-[180px]" src="/assets/DigiGrove Website.png" alt="" />
                    <img className="h-[180px]" src="/assets/DigiGrove Website Database.png" alt="" />
                    <img className="h-[180px]" src="/assets/Media Buying Card (2).png" alt="" />
                </div>
