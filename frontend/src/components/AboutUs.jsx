  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row relative gap-4 sm:gap-[48px]">
        <div className="relative z-10 sm:max-w-[40%] flex flex-col justify-center items-start sm:mb-[120px]">
          <h1 className="w-full flex justify-center sm:justify-start font-poppins text-[#8cc540] text-[32px] sm:text-[82px] 2xl:text-[96px] font-extrabold pb-4 sm:pb-12">
            About Us
          </h1>
          <h3 className="font-poppins text-center sm:text-left text-[16px] sm:text-[22px] 2xl:text-[40px] sm:leading-[32px] 2xl:leading-[44px] font-small py-1 sm:py-4">
          ...
          <h3 className="font-poppins text-[16px] sm:text-[22px] sm:leading-[32px] 2xl:leading-[44px] 2xl:text-[40px] mt-2 font-small px-3 sm:px-0">
