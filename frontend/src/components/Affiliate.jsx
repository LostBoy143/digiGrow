...
const Affiliate = () => {
  ...
  return (
    <div className="mt-[10%] w-full py-10">
      <div className="text-center md:ml-32 md:mr-28">
        <h1 className="xl:text-[128px] sm:text-8xl text-5xl whitespace-nowrap  font-thunder lg:leading-4 tracking-[0.06rem] text-[#8CC540] font-bold lg:mb-12 mb-4">
          AFFILIATE MARKETING
        </h1>
        <p className="font-poppins  md:text-[18px] text-xl font-medium text-[#232233] lg:mx-20 md:mx-16 mx-10">
        ...
        <div className="relative">
          ...
          >
            <div className="flex flex-col justify-center items-center ">
              ...
              <div className="glass relative text-white flex flex-col items-center gap-4 md:h-[520px] md:w-[600px] sm:h-[443px] sm:w-[404px]  bg-white/10 border border-white/20 rounded-[35px]">
                <img
                  src="/assets/Group 36.png"
                  alt="ellipses"
                  className="absolute z-10"
                ></img>
                <div className=" text-center pt-8  sm:px-10 flex flex-col md:gap-8  font-sans justify-center items-center space-y-10">
                  ...
                  <p className="font-normal text-base md:text-lg">
                    ...
                    purchases, or other transactions made by customers you
                    brought to Digigrove via the company&apos;s website, blog
                    posts, articles, banner ads, emails, landing pages, and
            ...
            <div className="flex flex-col justify-center items-center ">
              ...
              <div className="glass relative text-white flex flex-col items-center gap-4 md:h-[520px] md:w-[600px] sm:h-[443px] sm:w-[404px]  bg-white/10 border border-white/20 rounded-[35px]">
                ...
                <div className=" text-center pt-8  sm:px-10 flex flex-col md:gap-8  font-sans justify-center items-center space-y-10">
                  ...
                  <p className="font-normal text-base md:text-lg">
                    With our cutting-edge platform, Digigrove provide
                    unparalleled digital marketing services to facilitate
                    connections between brands and audiences that generate
                    noteworthy results. We specialize in both direct response
