  ...
  return (
    ...
    >
      <div className="main flex flex-row">
        <div className="left-side md:pl-[108px]  h-full w-full flex flex-col  sm:justify-evenly ">
          <div
            id="text"
            className=" text-[#8cc540]  px-5 pb-6 sm:p-0 sm:pb-0   "
          >
            <h3 className="md:tracking-[0.02em] leading-none text-center md:text-left  2xl:text-[110px] xl:text-[80px] md:text-[50px]   text-[40px] font-bold  font-thunder">
              EMAIL MARKETING
            </h3>
            <h3 className="md:tracking-[0.02em] leading-none text-center md:text-left  2xl:text-[110px] xl:text-[80px] md:text-[50px]  text-[40px]   font-bold  font-thunder">
              & LEAD GENERATION
